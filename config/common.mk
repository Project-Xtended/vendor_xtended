...
# Set all versions
XTENDED_VERSION := Xtended-$(XTENDED_BUILD)-$(PRODUCT_VERSION_MAINTENANCE)-$(XTENDED_BUILD_EXTRA)-$(XTENDED_BUILD_TYPE)-$(XTENDED_POSTFIX)
XTENDED_MOD_VERSION := Xtended-$(XTENDED_BUILD)-$(PRODUCT_VERSION_MAINTENANCE)-$(XTENDED_BUILD_EXTRA)-$(XTENDED_BUILD_TYPE)-$(XTENDED_POSTFIX)
