...
XTENDED_POSTFIX := -$(shell date +"%Y%m%d-%H%M")
...
# Set all versions
XTENDED_VERSION := Gzosp-$(XTENDED_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(XTENDED_BUILD_TYPE)$(XTENDED_POSTFIX)
XTENDED_MOD_VERSION := Gzosp-$(XTENDED_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(XTENDED_BUILD_TYPE)$(XTENDED_POSTFIX)

PRODUCT_PROPERTY_OVERRIDES += \
    BUILD_DISPLAY_ID=$(BUILD_ID) \
    xtended.ota.version=$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE) \
