...
PRODUCT_VERSION_MAINTENANCE = x8.5
XTENDED_POSTFIX := $(shell date +"%Y%m%d")
XTENDED_POSTFIX_XTRA := By-Team-Xtended
ifndef XTENDED_BUILD_TYPE
    XTENDED_BUILD_TYPE := UNOFFICIAL
endif

# Set all versions
XTENDED_VERSION := Xtended-$(XTENDED_BUILD)-$(PRODUCT_VERSION_MAINTENANCE)-$(XTENDED_BUILD_TYPE)-$(XTENDED_POSTFIX_XTRA)-$(XTENDED_POSTFIX)
XTENDED_MOD_VERSION := Xtended-$(XTENDED_BUILD)-$(PRODUCT_VERSION_MAINTENANCE)-$(XTENDED_BUILD_TYPE)-$(XTENDED_POSTFIX_XTRA)-$(XTENDED_POSTFIX)
XTENDED_XTRA_VERSION := $(PRODUCT_VERSION_MAINTENANCE)

PRODUCT_PROPERTY_OVERRIDES += \
    BUILD_DISPLAY_ID=$(BUILD_ID) \
    xtended.ota.version=$(PRODUCT_VERSION_MAJOR)-$(PRODUCT_VERSION_MAINTENANCE) \
    ro.xtended.version=$(XTENDED_XTRA_VERSION) \
    ro.modversion=$(XTENDED_XTRA_VERSION) \
