...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := healthd_board_xtended.cpp
LOCAL_MODULE := libhealthd.xtended
LOCAL_CFLAGS := -Werror
LOCAL_C_INCLUDES := \
...
include $$(CLEAR_VARS)
LOCAL_MODULE := vendor_xtended_charger_$(notdir $(1))
...
include $(CLEAR_VARS)
LOCAL_MODULE := xtended_charger_res_images
LOCAL_MODULE_TAGS := optional
